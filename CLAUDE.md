...
| 역량검사 | 역량검사 4.0 | |
| 교차진단 | 교차검증 진단 (프리즘 × 역량검사) | source of truth: 스토리북(index.html) 교차진단 컴포넌트 · Figma 「교차진단」 (2026-07-27 반영) |
...
> ## ── 이하 교차진단 컴포넌트 ──
> 아래는 교차진단(프리즘 × 역량검사)에서 도입한 컴포넌트(**주 사용 제품: 교차진단**, 참고). 다른 제품에서도 재사용할 수 있다. source of truth: 스토리북(index.html) 교차진단 섹션 · Figma 「교차진단」 (2026-07-27 반영).
...
- ⚠ 프리즘 BP 등급 칩(g-*)·표준 등급 색상과 **별개 체계로 공존** (기존 토큰 덮어쓰기 금지). 하 #FF006B는 리스크 시인성 강조용
...
| 교차진단 | ../logo/logo_prism.png + ../logo/logo_monster.png (둘 다) | - |
